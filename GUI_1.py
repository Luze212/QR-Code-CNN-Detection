...
from PySide6.QtCore import Qt, QSize, Signal # Signal statt pyqtSignal
from PySide6.QtGui import QPixmap, QPainter, QPen, QColor, QDoubleValidator, QAction, QCursor, QFont
